...
{\bf\large 1. Background \& Motivation} \addcontentsline{toc}{section}{1. Background \& Motivation} 
\input{sec/intro.tex}
...
\input{sec/magfield.tex}

\input{sec/project.tex}
...
\input{sec/pending.tex}

\clearpage

\input{sec/budget.tex}
