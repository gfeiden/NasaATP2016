...
\captionsetup[figure]{labelfont={footnotesize, bf, it}, textfont={small, it}, labelsep=colon, labelformat=simple}
...
{\bf\large 1. Introduction} \addcontentsline{toc}{section}{Introduction} \\

\clearpage

{\bf\large 2. Magnetic Fields in (sub)Stellar Evolution} \addcontentsline{toc}{section}{Magnetic Fields in (sub)Stellar Evolution} \\
